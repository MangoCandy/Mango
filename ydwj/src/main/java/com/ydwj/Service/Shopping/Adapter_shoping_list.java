 ...
 */
public class Adapter_shoping_list extends BaseAdapter{
    List<Market> markets;
    public Adapter_shoping_list(List<Market> markets){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView=LayoutInflater.from(parent.getContext()).inflate(R.layout.single_shop_list,null);
